...
const BULK_HARDWARE_TYPE_ALIASES = new Map([
  ...
  ['scanner', 'Tarayıcı'],
  ['dock', 'Dock İstasyonu'],
  ['dockistasyonu', 'Dock İstasyonu'],
  ['adaptorsarjcihazi', 'Adaptör / Şarj Cihazı'],
  ['adaptor', 'Adaptör / Şarj Cihazı'],
  ['sarjcihazi', 'Adaptör / Şarj Cihazı'],
  ['charger', 'Adaptör / Şarj Cihazı'],
